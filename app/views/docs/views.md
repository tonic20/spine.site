...
`.jeco` также имеют преимущество в том, что вы можете передавать в них массив для рендеринга, а они будут автоматически пробегать по немe и рендерить коллекцию элементов.
